<!-- badges: start -->
![GitHub](https://img.shields.io/github/license/inbo/natuurherstel_cmon)
![GitHub Workflow Status](https://img.shields.io/github/actions/workflow/status/inbo/natuurherstel_cmon/check-project)
![GitHub repo size](https://img.shields.io/github/repo-size/inbo/natuurherstel_cmon)
<!-- badges: end -->

# Sample size for carbon stocks in forests
